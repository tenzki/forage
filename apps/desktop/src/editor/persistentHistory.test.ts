...
function event(type: 'document.steps_applied' | 'document.undo_applied' | 'document.redo_applied', id: string, targets?: string[]): EventEnvelope {
  return parseEventEnvelope({
    ...
    origin: 'desktop', occurredAt: '2026-08-30T00:00:00.000Z', changeGroupId: 'group',
    payload: {
